...
現在自分は趣味で他に自作言語のコンパイラ製作をしています（[今年初めの記事](/post/my_goals_for_2023)で考えていた通り）。だた、自作言語はたいていどうしても実用性に欠けてしまいます。メジャーな言語のコンパイラや標準ライブラリなどの開発にたくさんの人の膨大な努力が注がれているのを見ると、やはり実用に足る言語はそう簡単には作れないことを思い知らされてしまいます。
